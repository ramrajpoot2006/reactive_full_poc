...
public class CustomExceptionHandler implements ProblemHandling {
  ...
  public Mono<ResponseEntity<Problem>> handleCustomException(Exception e,
  ...
  public Mono<ResponseEntity<Problem>> handleNotFoundException(NotFoundException e,
  ...
  private Mono<ResponseEntity<Problem>> getProblemResponse(Violation violation,
      ServerWebExchange request) {
    String errDetails;
